...
> [!infobox]  
> **Pronounced:** `VIEW[{pronounced}]` (`VIEW[{pronouns}]`)  
...
> ---|---|  
> **Alias(es)** | `VIEW[{alias}]` |  
> **Occupation(s)** | `VIEW[{occupation}]` |  
> **Faction(s)** | `VIEW[{faction}][text(renderMarkdown)]` |  
> **Religion(s)** | `VIEW[{religion}][text(renderMarkdown)]` |  
> **Background:** | `VIEW[{background}]` |  
> **Class:** | `VIEW[{class}]` |  
> **Level:** | `VIEW[{level}]` |  
> **Current Location** | `VIEW[{location}][text(renderMarkdown)]` |  
> **Default Action:** | `VIEW[{action}]` |
...
>> - **Goals:**  
>> `VIEW[{goals}][text(renderMarkdown)]`
>>   
>> - **Needs:**  
>> `VIEW[{needs}][text(renderMarkdown)]`

## Relationships
>[!column|clean no-title] Relationships
>> [!metadata|bg-c-green]- Friends & Family
>> - `VIEW[{friends-family}][text(renderMarkdown)]`
>
>> [!metadata|bg-c-orange]- Rivals
>> - `VIEW[{rivals}][text(renderMarkdown)]`
